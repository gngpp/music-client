...
export const loginInfo = (params) => post('/user/login/info',params)
// 注册
export const SignUp = (params) => post(`api/app/sign_in`, params)
// 更新用户信息
export const updateUserMsg = (params) => put(`api/app/user/update`, params)
// 返回指定ID的用户
...
// 修改密码
export const changePass = (params) => put('api/app/user/security',params)

// =======================> 业务 API
// 开通会员
export const membershipBusiness = (params) => post('api/app/club_card/membership',params)

// 获取开通会员后过期时间
export const getAfterExpireTime = (consumerId, month) => get(`api/app/club_card/membership/after_expire?consumerId=${consumerId}&afterMonth=${month}`)
export const getCurrentExpireTime = (consumerId) => get(`api/app/club_card/membership/current_expire?consumerId=${consumerId}`)
...
// 取消收藏
export const deleteCollection = (params) => put(`api/app/collection/delete`, params)
